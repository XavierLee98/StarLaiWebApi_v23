...
namespace StarLaiPortal.Module.BusinessObjects.View
{
    ...
    [XafDisplayName("GRPO List")]
    public class vwPRRPO : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public vwPRRPO(Session session)
            : base(session)
        {
        }
        ...
        [Index(3), VisibleInListView(true), VisibleInDetailView(false), VisibleInLookupListView(false)]
        ...
        [Appearance("SAPPODocNum", Enabled = false)]
        [Index(40), VisibleInListView(true), VisibleInDetailView(true), VisibleInLookupListView(true)]
        public string SAPPODocNum
        {
            get; set;
        }

        [XafDisplayName("VendorRef")]
        [Appearance("VendorRef", Enabled = false)]
