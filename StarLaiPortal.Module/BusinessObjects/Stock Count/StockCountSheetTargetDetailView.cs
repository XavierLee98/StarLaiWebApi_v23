...
namespace StarLaiPortal.Module.BusinessObjects.Stock_Count
{
    ...
    public partial class StockCountSheetTargetDetailView : ObjectViewController<ListView, StockCountSheetTarget>
    {
        // Use CodeRush to create Controllers and Actions with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/403133/
        public StockCountSheetTargetDetailView()
        {
            InitializeComponent();
        ...
        {
            if (e.CreatedObject is StockCountSheetTarget && View.IsRoot == false)
            {
                StockCountSheetTarget currentObject = (StockCountSheetTarget)e.CreatedObject;
