...
namespace StarLaiPortal.Module.BusinessObjects.Sales_Return
{
    ...
    //[RuleCriteria("SRRPrice", DefaultContexts.Save, "IsValid = 0", "Price cannot zero.")]
    [RuleCriteria("SRRUnitCost", DefaultContexts.Save, "IsValid1 = 0", "Unit Cost cannot zero.")]

    public class SalesReturnRequestDetails : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public SalesReturnRequestDetails(Session session)
            : base(session)
        {
        }
        ...
        [XafDisplayName("Invoice Quantity")]
        ...
        [Appearance("UnitCost", Enabled = false, Criteria = "BaseDoc != null")]
