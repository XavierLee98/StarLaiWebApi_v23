...
namespace StarLaiPortal.Module.BusinessObjects.Pick_List
{
    ...
    public partial class PickListDetailView : ViewController
    {
        ...
        {
            if (e.CreatedObject is PickListDetailsActual && View.IsRoot == false)
            {
                PickListDetailsActual currentObject = (PickListDetailsActual)e.CreatedObject;
                ...
                if (lv.CollectionSource is PropertyCollectionSource)
                {
                    ...
                    if (collectionSource.MasterObject != null)
                    {
                        ...
                        if (collectionSource.MasterObjectType == typeof(PickList))
                        {
                            PickList masterobject = (PickList)collectionSource.MasterObject;
