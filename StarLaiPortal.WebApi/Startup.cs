...
using StarLaiPortal.WebApi.JWT;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXafAspNetCoreSecurity(Configuration, options => {
            ...
            options.UserType = typeof(StarLaiPortal.Module.BusinessObjects.ApplicationUser);
            // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
            // If you use PermissionPolicyUser or a custom user type, comment out the following line:
            options.UserLoginInfoType = typeof(StarLaiPortal.Module.BusinessObjects.ApplicationUserLoginInfo);
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "StarLaiPortal API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the StarLaiPortal.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
