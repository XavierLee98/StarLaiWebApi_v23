...
namespace StarLaiPortal.WebApi.API.Controller
{
    ...
    public class VehicleController : ControllerBase
    {
        ...
        public VehicleController(IConfiguration configuration, IObjectSpaceFactory objectSpaceFactory, ISecurityProvider securityProvider)
        {
        ...
        public IActionResult Get()
        {
            try
            {
                ...
                {
                    var val = conn.Query($"exec sp_getdatalist 'Vehicle'").ToList();
